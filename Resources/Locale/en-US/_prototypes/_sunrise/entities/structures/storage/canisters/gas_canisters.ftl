...
ent-ElectrovaeCanister = electrovae canister
    .desc = A canister that can contain any type of gas. This one is supposed to contain electrovae. It can be attached to connector ports using a wrench.
ent-ChargedElectrovaeCanister = charged electrovae canister
    .desc = A canister that can contain any type of gas. This one is supposed to contain charged electrovae. It can be attached to connector ports using a wrench.
