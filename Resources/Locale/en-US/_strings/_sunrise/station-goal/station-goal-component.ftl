...
station-goal-bank =⠀​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] собрать медкоплекты, состоящии из таблеток и средств наружного применения, от каждого вида повреждений и перенести всё в хранилище.
    ...
    ⠀— [bold]Научному отделу:[/bold] изучить, изготовить и перенести в орбитальное хранилище минимум пять плат из числа технологий третьего уровня.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
