...
station-goal-personnel-recovery = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] составить общий отчет, содержащий информацию о состоянии данных тел в момент поступления в медицинских отдел, провести их полное восстановление, одеть в комбинезоны и поместить в капсулы криогенного сна.
