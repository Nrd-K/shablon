...
station-goal-medical-replenishment = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] Произвести 19 наименований препаратов в указанных объемах, сформировать 7 типов медицинских наборов.
...
​    ⠀​​[italic]Установленная Цель смены может быть заменена, отменена или пересмотрена в ходе смены по решению Центрального Командования в одностроннем порядке.[/italic]
    ...
    ⠀— [bold]Инженерному отделу:[/bold]Построить в вирусологии морг с 6 морозильниками, 3 стазисными кроватями, ящиками хирургических инструментов и мешками для трупов. К нему должно быть пристроено хранилище для образцов крови. Хранилище и морг должны иметь: общий и единственный выход на станцию через вирусологию, слой укрепленных стен, минусовую температуру, гермозатворы.
    ⠀— [bold]Отделу Снабжения:[/bold] Добыть 6 туш разных видов фауны, минимум по две особи каждой. 
...
​    ⠀​​[italic]Установленная Цель смены может быть заменена, отменена или пересмотрена в ходе смены по решению Центрального Командования в одностроннем порядке.[/italic]
    ...
    ⠀— [bold]Инженерному отделу:[/bold]Построить в вирусологии 2 комнаты с кроватями, каждая из которых должна быть надёжно защищена от возможного побега из неё. Построить бункер с двойным слоем укрепленных стен, 2 гермозатворами, ящиком медикаментов и морозильником с едой, для долгого пребывания в бункере. 
    ⠀— [bold]Отделу Снабжения:[/bold] Заказать все необходимые материалы, медикаменты и продовольствие. 
    ⠀— [bold]Научному отделу:[/bold] Создать и перенести в вирусологию: 2 ХимМастера 4000, 2 Раздатчика химикатов.
    ...
    ⠀— [bold]Сервисному отделу:[/bold] Приготовить и перенести в бункер 20 блюд и 20 напитков.
...
​    ⠀​​[italic]Установленная Цель смены может быть заменена, отменена или пересмотрена в ходе смены по решению Центрального Командования в одностроннем порядке.[/italic]
    ...
    ⠀— По завершении цели - покинуть станцию на эвакуационном шаттле.
    ⠀— [bold]ВАЖНО:[/bold] В случае отказа большей части экипажа станции от содействия в выполнении цели, разрешается применить нелетальные уровни силы. Дальнейший отказ членов экипажа приравнивается к саботажу цели.
    ⠀Ответственные за цель: [bold]Инженерный отдел, Медицинский отдел, Служба Безопасности, Отдел Снабжения, Капитан объекта { $station }[/bold].
