...
station-goal-bank =⠀​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] приготовить и перенести в хранилище продвинутые медикаменты минимум от трёх разных видов повреждений.
    ⠀— [bold]Сервисному отделу:[/bold] приготовить не менее десяти блюд, создать не менее трёх разных вида лучших семян, и перенести всё перечисленное в хранилище.
    ⠀— [bold]Научному отделу:[/bold] создать и перенести в хранилище минимум пять ценных плат.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
...
station-goal-zoo =⠀​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Отделу Снабжения:[/bold] заказать разных видов животных, равных количеству простроенных вольеров, перенести их в вольеры и обеспечить проект всеми необходимыми материалами.
    ⠀— [bold]Сервисному отделу:[/bold] обеспечить животных: едой, водой, лежанками для каждого животного. 
    ⠀— [bold]ВАЖНО:[/bold] животные должны оставаться живыми до конца смены.
...
station-goal-mining-outpost = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] приготовить и перенести в аванпост медкомплекты минимум от трёх разных видов повреждений. Медкомплекты должны состоять из средств наружного применения и таблеток.
    ⠀— [bold]Сервисному отделу:[/bold] приготовить 500u алкоголя, двадцать закусок и перенести всё перечисленное в аванпост.
    ⠀— [bold]Научному отделу:[/bold] разработать необходимые платы и технологии.
...
station-goal-delta-xeno-repair = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Научному отделу:[/bold] поймать и поместить в камеры шесть слаймов любого вида, а также провести над ними минимум три различных эксперимента и задокументировать их.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
    ⠀— [bold]ВАЖНО:[/bold] документация должна быть заверена Научным Руководителем и Капитаном. В случае отсутствия заброшенного сектора ксенобиологии научного отдела на объекте { $station } цель автоматически меняется на расширение/строительство сектора ксенобиологии:
    ⠀— [bold]Инженерному отделу:[/bold] построить: две дополнительных камеры сдерживания существ/сектор ксенобиологии с атмосферой, двумя рабочими местами ксенобиологов и шестью камерами сдерживания существ.
...
station-goal-weapon-sec = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Научному отделу:[/bold] изучить десять указанных технологий вооружения, а после изготовить на производственных мощностях станции минимум по две единицы оружия, боеприпасов и плат для каждой исследованной технологии.
    ⠀— [bold]Службе Безопасности:[/bold] проконтролировать изготовление указанного количества оружия, боеприпасов и плат.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
    ⠀— [bold]ВАЖНО:[/bold] использование данного оружия разрешено только сотрудникам Службы Безопасности.
...
station-goal-battle-shuttle = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить пилотируемый боевой шаттл, превосходящий по размерам стандартный, установить в нём восемь орудийных систем («Perforator» и «Friendship») и обеспечить шаттл системой жизнеобеспечения и боеприпасами.
    ⠀— [bold]Научному отделу:[/bold] разработать необходимые платы и технологии.
...
station-goal-nuke-room = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить новое хранилище размером 5х5 вблизи мостика с двойной обшивкой из укреплённых стен, обеспечить его системой жизнеобеспечения и двумя гермозатворами с дистанционным управлением.
...
station-goal-permabrig = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] расширить перманентный бриг в три раза по ширине, построить: четыре новые камеры, три новых карцера, расширенные кухню и гидропонику, комнату свиданий, установить три новых развлекательных автомата.
...
station-goal-training-crew = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Всем отделам:[/bold] необходимо провести публичную лекцию по своей специализации.
...
station-goal-medical-replenishment = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] произвести девятнадцать различных препаратов в объеме минимум 200u и сформировать не менее трёх медицинских наборов от различных повреждений.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
...
station-goal-delegates = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Сервисному отделу:[/bold] поддерживать чистоту станции, её освещение вплоть до конца смены, а также приготовить не менее 20 блюд и перенести их на мостик.
    ⠀— [bold]Медицинскому отделу:[/bold] приготовить медикаменты от: ядов, механических и термических повреждений и перенести их на мостик.
    ⠀— [bold]Научному отделу:[/bold] изучить минимум три технологические ветки до третьего уровня и модифицировать все отделы, добавив минимум по два изученного оборудования в каждый.
...
station-goal-cleaning-up = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Отряду { $station }:[/bold] обойти все комплексы и составить подробный отчет, при наличии агрессивной фауны, произвести полную зачистку комплексов и 40% площади планетоида.
...
station-goal-humanitarian-aid = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Медицинскому отделу:[/bold] произвести двадцать четыре лекарств в объёме по 200u каждое.
...
station-goal-personnel-recovery = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Отделу Снабжения:[/bold] найти и доставить в медотсек минимум пять тел пропавшего персонала.
...
station-goal-sample-collection = ​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить в вирусологии морг с шестью морозильниками, тремя стазисными кроватями, ящиками хирургических инструментов и мешками для трупов. К нему должно быть пристроено хранилище для образцов крови. Хранилище и морг должны иметь: общий и единственный выход на станцию через вирусологию, слой укрепленных стен, минусовую температуру, гермозатворы.
    ⠀— [bold]Отделу Снабжения:[/bold] добыть шесть туш разных видов фауны, минимум по две особи каждой. 
    ⠀— [bold]Медицинскому отделу:[/bold] собрать образцы крови, минимум по 60u с каждого вида фауны, и переместить их в хранилище, рассортировав образцы по видам существ. Также рассортировать полученную фауну в морге.
...
station-goal-virology = ​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить в вирусологии две комнаты с кроватями, каждая из которых должна быть надёжно защищена от возможного побега из неё. Построить бункер с двойным слоем укрепленных стен, двумя гермозатворами, ящиком медикаментов и морозильником с едой, для долгого пребывания в бункере. 
    ⠀— [bold]Отделу Снабжения:[/bold] заказать все необходимые материалы, медикаменты и продовольствие. 
    ⠀— [bold]Научному отделу:[/bold] создать и перенести в вирусологию: два ХимМастера 4000, два Раздатчика химикатов.
    ⠀— [bold]Медицинскому отделу:[/bold] приготовить и перенести в бункер медицину от: термических повреждений, ядов, механических повреждений.
    ⠀— [bold]Сервисному отделу:[/bold] приготовить и перенести в бункер двадцать блюд и двадцать напитков.
