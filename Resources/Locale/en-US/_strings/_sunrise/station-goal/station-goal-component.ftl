...
station-goal-virology = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold]Построить в вирусологии 2 комнаты с кроватями, каждая из которых должна быть надёжно защищена от возможного побега из неё. Построить бункер с двойным слоем укрепленных стен, 2 гермозатворами, ящиком медикаментов и морозильником с едой, для долгого прибывания в бункере. 
...
station-goal-health-examination = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— По завершению цели - покинуть станцию на эвакуационном шаттле.
