...
station-goal-mining-outpost = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить отдельно от станции аванпост с защитой от метеоритов в виде слоя укреплённых стен и слоя сетки. Обеспечить аванпост: автономным питанием, гравитацией, двумя жилыми комнатами на двоих, складом.
    ...
    ⠀— [bold]Сервисному отделу:[/bold] приготовить 600u пива, 600u безалкогольных напитков, двадцать блюд и перенести всё перечисленное в аванпост.
    ⠀— [bold]Научному отделу:[/bold] разработать необходимые платы и технологии.
...
station-goal-reports = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] настроить два промышленных генератора электричества и криокапсулы в медицинском отделе.
...
station-goal-intelligent-weapons = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Службе Безопасности:[/bold] проконтролировать отсутствие посторонних на цели и обеспечить усиленное сдерживание данных особей в ксеноархеологии.
    ⠀— [bold]Инженерному отделу:[/bold] построить всё необходимое для сдерживания особей.
    ⠀— [bold]Сервисному отделу:[/bold] обеспечить особей едой и водой.
    ⠀— [bold]ВАЖНО:[/bold] по окончании доставить подконтрольных особей на станцию трансфера. В случае длительного отсутствия видимых признаков разума у существ после введения когнизина, цель на объекте { $station } автоматически меняется на изучение данных особей:
    ⠀— [bold]Научному отделу:[/bold] провести и задокументировать не менее трёх экспериментов над каждой особью.
    ⠀— [bold]Остальным отделам, ответственным за цель:[/bold] задачи остаются без изменений.
    ⠀— [bold]ВАЖНО:[/bold] документация должна быть заверена Научным Руководителем и Капитаном.
...
station-goal-anomaly = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Научному отделу:[/bold] сгенерировать или найти четыре аномалии разного типа, провести их подробное изучение, в частности воздействие их коллапса на окружающую среду, составить "Отчет об изучении объекта" для каждой аномалии и отправить данные отчёты на факс Центрального Командования.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
    ⠀— [bold]ВАЖНО:[/bold] заказы ученых для выполнения цели получают высший приоритет.
...
station-goal-cyborgs = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] построить отдельное помещение для киборгов вблизи ядра ИИ.
    ⠀— [bold]Научному отделу:[/bold] создать: восемь станций зарядки киборгов, восемнадцать киборгов, оснастив их батареей высокой ёмкости, восемнадцать инструментальных модулей киборга и по два продвинутных модуля киборгов каждой доступной модели. Все перечисленное перенести и установить в подготовленное помещение вблизи ядра ИИ.
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить цель всеми необходимыми материалами.
...
station-goal-delegates = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Инженерному отделу:[/bold] отремонтировать станцию, поддерживать её целостность вплоть до конца смены, а также запустить промышленный генератор электричества.
...
station-goal-personnel-recovery = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]ВАЖНО:[/bold] отчет немедленно отправить на факс Центрального Командования.
...
station-goal-church = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Сервисному отделу:[/bold] провести три проповеди/лекции, каждая из которых должна быть посвящена отдельной религии. Темы проповедей/лекций не должны повторяться.
